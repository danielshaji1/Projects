...
def decrypt_cbc(ciphertext, key, iv):
    ...
    Returns plaintext WITH padding if padding is valid, None otherwise (padding oracle).
    Note: Padding is NOT removed - the caller is responsible for that.
    """
    aes = AES(key)
    plaintext = b""

    # Initialize the previous block as the IV
    previous_block = iv
...
'''def main():
    ...
    print(decrypt_cbc(cipher_block, key, iv) is not None)
    print(decrypt_cbc(cipher_block, key, bytes(test)) is not None)
